...
public class Utils {
	...
	protected static final SimpleDateFormat sdfNumber_Ymd = new SimpleDateFormat("yyyyMMdd");
	...
	public static String getDayNumber_Ymd(Date d) {
		if(d == null) return "";
		return sdfNumber_Ymd.format(d);
	}
