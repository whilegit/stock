...
public class BaseOplog<M extends BaseOplog<M>> extends JModel<M> implements IBean {

	private static final long serialVersionUID = 1L;
	
	public static final String CACHE_NAME = "oplog";
	public static final String METADATA_TYPE = "oplog";

	public static final String ACTION_ADD = "oplog:add";
	public static final String ACTION_DELETE = "oplog:delete";
	public static final String ACTION_UPDATE = "oplog:update";
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof BaseOplog<?>)){return false;}

		BaseOplog<?> m = (BaseOplog<?>) o;
	...
	public java.math.BigInteger getUid() {
		...
		return uid instanceof BigInteger ? (BigInteger)uid : new BigInteger(uid.toString());
	}
