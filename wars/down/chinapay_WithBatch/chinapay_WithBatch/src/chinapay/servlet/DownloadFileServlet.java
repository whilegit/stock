...
public class DownloadFileServlet extends HttpServlet {
	...
	private static final String PaymentUrl = "chinapay.DownFile.url";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String orFileName = merId + "_" + TransDate + "_" + MerSeqId + "_Q.txt";
		System.out.println("orFileName=[" + orFileName + "]");

		// 回盘文件命名规范：MERID_YYYYMMDD_XXXXXX_P.TXT
		String fileName = merId + "_" + TransDate + "_" + MerSeqId + "_P.txt";
		...
		try {
			...
			System.out.println("回盘文件下载接口返回报文result=[" + result + "]");
			...
			if (str.length == 5) {
				...
				String resultText = new String(MsgUtil.decodeInflate(FileData
						.getBytes()), "UTF-8");
